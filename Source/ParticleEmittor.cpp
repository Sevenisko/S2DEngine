/************************************************************\
    ...
    Purpose: The particle emittor itself
...
void ParticleEmittor::setStyle(ParticleStyle style)
{
    if (style_ == style)
    {
        return;
