/************************************************************\
    ...
    Purpose: Implementation of the Particle system
    Note: This code is NOT written by me!
    Source: https://github.com/scarsty/SDL2-particles
\************************************************************/

#ifndef S2D_PARTICLES_INCLUDED
#define S2D_PARTICLES_INCLUDED
...
public:
     ...
     * @return The gravity.
     */
    virtual const EVec2& getGravity();
    /** Sets the gravity.
     *
     * @param g The gravity.
     */
    virtual void setGravity(const EVec2& g);
    /** Gets the speed.
     *
     * @return The speed.
     */
