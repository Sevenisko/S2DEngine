...
namespace ImGui
{
    ...
    IMGUI_API bool          DragFloatN_Colored(const char* label, std::vector<float*> v, std::vector<ImU32> colors, float v_speed, float v_min, float v_max, const char* display_format, float power);
